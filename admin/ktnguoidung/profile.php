...
<div class="card-body">
	<from method="post" enctype="multipart/form-date" action="../ktnguoidung/index.php" >
	...
	<div class="my-3">
		...
		<input class="form-control" type="email" name="txtmail" placeholder="Email" value="<?php echo $_SESSION["nguoidung"]["email"]; ?>" required>	
	</div>
	<div class="my-3">
		<label class="from-label">Số điện thoại</label>
		<input class="form-control" type="number" name="txtdienthoai" placeholder="Số điện thoạt" value="<?php echo $_SESSION["nguoidung"]["sodienthoai"]; ?>" required>	
	</div>
	<div class="my-3">
		<label class="from-label">Họ tên</label>
		<input class="form-control" type="text" name="txthoten" placeholder="Họ tên" value="<?php echo $_SESSION["nguoidung"]["hoten"]; ?>" required>	
	</div>
	<div class="my-3">
		<label class="from-label">Đổi hình đại diện</label>
		<input class="form-control" type="file" name="fhinh">	
	</div>
	<div class="my-3 text-center">
		<input class="btn btn-primary" type="submit" value="Cập nhật">
		<input class="btn btn-primary" type="reset" value=" không" >	
	</div>
	</from>
</div>
</div>
