		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">ABC Shop</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php if(strpos($_SERVER["REQUEST_URI"],"qldanhmuc") !=false) echo "action";  ?>">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <i class="align-middle" data-feather="settings"></i>
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<img src="<?php if($_SESSION["nguoidung"]["hinhanh"] != null) echo "../../images/users/user.png"; ?>" class="avatar img-fluid rounded me-1" alt="Quản trị viên" /> 
